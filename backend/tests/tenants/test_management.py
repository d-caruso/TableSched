...
def test_create_tenant_without_domain():
    ...
    call_command("create_tenant", name="Restaurant X", schema=schema_name, stdout=out)

    assert Restaurant.objects.filter(schema_name=schema_name, name="Restaurant X").exists()
...
def test_create_tenant_with_domain():
    ...
    call_command("create_tenant", name="Restaurant X", schema=schema_name, domain=domain_name)
